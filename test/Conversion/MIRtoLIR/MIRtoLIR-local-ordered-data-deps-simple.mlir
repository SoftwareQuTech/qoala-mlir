...
module {
  ...
  // CHECK: netqasm.local_routine @[[WRAPPER0:.*]](%[[ARG0_0:.*]]: i32, %[[ARG1_0:.*]]: i32, %[[ARG2_0:.*]]: i32, %[[ARG3_0:.*]]: i32) -> i1
  // CHECK-NEXT: %[[REG0_0:.*]] = netqasm.qalloc : i32
  // CHECK-NEXT: netqasm.init %[[REG0_0]]
  // CHECK-NEXT: netqasm.rot_x %[[REG0_0]], %[[ARG0_0]], %[[ARG1_0]]
  // CHECK-NEXT: netqasm.rot_y %[[REG0_0]], %[[ARG2_0]], %[[ARG3_0]]
  ...
  qmem.func @test_local_quantum_program() {
    ...
    // CHECK: %[[REG_MAIN2:.*]] = qoalahost.call @[[WRAPPER0]](%[[REG_MAIN0]]#0, %[[REG_MAIN0]]#1, %[[REG_MAIN1]]#0, %[[REG_MAIN1]]#1) : (i32, i32, i32, i32) -> i1
    qmem.rot_x %0, %cst_0
    qmem.rot_y %0, %cst_1
    %2 = qmem.measure %0 : i1
