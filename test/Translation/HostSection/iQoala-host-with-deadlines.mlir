...
module {
  ...
  qoalahost.main_func @test_qubit_tracking() {
    ...
    qoalahost.nop_term
  ^bb1:
    qoalahost.blk_meta  {block_id = "block_1", deadlines = {"block_0" = 100}, dependencies = [], predecessors = [], prev_comm = "", prev_ent = ""}
    %0 = qoalahost.call @__qoala_wrapper0() : () -> i32
  ^bb2:
    qoalahost.blk_meta  {block_id = "block_2", deadlines = {"block_0" = 500, "block_1" = 300}, dependencies = ["block_1"], predecessors = [], prev_comm = "", prev_ent = ""}
