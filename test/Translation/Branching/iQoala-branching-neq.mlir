...
// CHECK-NEXT: bne C[[C_REG1]] R[[ARG0_REG]] 2
// CHECK-NEXT: jmp 3
...
module {
  ...
  qoalahost.main_func @test_branching_neq() {
  ...
  ^bb1:
    qoalahost.blk_meta  {block_id = "block_1", deadlines = {}, dependencies = [], predecessors = ["block_0"], prev_comm = "", prev_ent = ""}
    cf.br ^bb3
  ^bb2:
    qoalahost.blk_meta  {block_id = "block_2", deadlines = {}, dependencies = [], predecessors = ["block_0"], prev_comm = "", prev_ent = ""}
    cf.br ^bb3
  ^bb3:
    qoalahost.blk_meta  {block_id = "block_3", deadlines = {}, dependencies = ["block_0"], predecessors = ["block_1", "block_2"], prev_comm = "", prev_ent = ""}
