...
// CHECK: qoalahost.blk_meta  {block_id = "[[BLOCK_7:.*]]", deadlines = {}, dependencies = ["[[BLOCK_5]]"], predecessors = [], prev_comm = "", prev_ent = ""}
// CHECK: qoalahost.blk_meta  {block_id = "[[BLOCK_8:.*]]", deadlines = {}, dependencies = ["[[BLOCK_6]]"], predecessors = [], prev_comm = "[[BLOCK_7]]", prev_ent = ""}
