...
// CHECK: qoalahost.blk_meta  {block_id = "[[BLOCK_6:.*]]", deadlines = {}, dependencies = ["[[BLOCK_4]]", "[[BLOCK_5]]"], predecessors = [], prev_comm = "", prev_ent = ""}
...
module {
  ...
  qoalahost.main_func @test_reordering_teleport() {
    ...
    ^bb6:
        qoalahost.blk_meta  {block_id = "block_6", deadlines = {}, dependencies = ["block_4", "block_5"], predecessors = [], prev_comm = "", prev_ent = ""}
