...
module {
    ...
    ^bb2:
      qoalahost.blk_meta  {block_id = "block_2", predecessors = ["block_1"], dependencies = ["block_1"], prev_comm = "", prev_ent = ""}
      %m1 = qoalahost.call @subrt1(%vqubit1) : (i32) -> i1
    
    ^bb3:
      qoalahost.blk_meta  {block_id = "block_3", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_1"}
      %vqubit2 = qoalahost.call @req2() : () -> i32
    
    ^bb4:
      qoalahost.blk_meta  {block_id = "block_4", predecessors = ["block_3"], dependencies = ["block_3"], prev_comm = "", prev_ent = ""}
      %m2 = qoalahost.call @subrt2(%vqubit2) : (i32) -> i1
    
    ^bb5:
      qoalahost.blk_meta  {block_id = "block_5", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_3"}
      %vqubit3 = qoalahost.call @req3() : () -> i32
    
    ^bb6:
      qoalahost.blk_meta  {block_id = "block_6", predecessors = ["block_5"], dependencies = ["block_5"], prev_comm = "", prev_ent = ""}
      %m3 = qoalahost.call @subrt3(%vqubit3) : (i32) -> i1
    
    ^bb7:
      qoalahost.blk_meta  {block_id = "block_7", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_5"}
