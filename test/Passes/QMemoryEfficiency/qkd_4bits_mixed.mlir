...
module {
    ...
    ^bb2:
      qoalahost.blk_meta  {block_id = "block_2", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_1"}
      %vqubit2 = qoalahost.call @req2() : () -> i32
    
    ^bb3:
      qoalahost.blk_meta  {block_id = "block_3", predecessors = ["block_1"], dependencies = ["block_1"], prev_comm = "", prev_ent = ""}
      %m1 = qoalahost.call @subrt1(%vqubit1) : (i32) -> i1
    
    ^bb4:
      qoalahost.blk_meta  {block_id = "block_4", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_2"}
      %vqubit3 = qoalahost.call @req3() : () -> i32
    
    ^bb5:
      qoalahost.blk_meta  {block_id = "block_5", predecessors = ["block_2"], dependencies = ["block_2"], prev_comm = "", prev_ent = ""}
      %m2 = qoalahost.call @subrt2(%vqubit2) : (i32) -> i1
    
    ^bb6:
      qoalahost.blk_meta  {block_id = "block_6", predecessors = ["block_4"], dependencies = ["block_4"], prev_comm = "", prev_ent = ""}
      %m3 = qoalahost.call @subrt3(%vqubit3) : (i32) -> i1
    
    ^bb7:
      qoalahost.blk_meta  {block_id = "block_7", predecessors = [], dependencies = [], prev_comm = "", prev_ent = "block_4"}
      %vqubit4 = qoalahost.call @req4() : () -> i32
    
    ^bb8:
      qoalahost.blk_meta  {block_id = "block_8", predecessors = ["block_7"], dependencies = ["block_7"], prev_comm = "", prev_ent = ""}
      %m4 = qoalahost.call @subrt4(%vqubit4) : (i32) -> i1
    
    ^bb9:
      qoalahost.blk_meta  {block_id = "block_9", predecessors = [], dependencies = [], prev_comm = "", prev_ent = ""}
      qoalahost.return
