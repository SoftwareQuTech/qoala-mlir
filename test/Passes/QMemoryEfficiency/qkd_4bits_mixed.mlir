...
module {
    ...
    qoalahost.main_func @test_qkd_4bits_mixed_qmem() {
    ...
    ^bb2:
      qoalahost.blk_meta  {block_id = "block_2", predecessors = [], deadlines = {}, dependencies = [], prev_comm = "", prev_ent = "block_1"}
      %vqubit2 = qoalahost.call @req2() : () -> i32
    
    ^bb3:
      qoalahost.blk_meta  {block_id = "block_3", predecessors = ["block_1"], deadlines = {}, dependencies = ["block_1"], prev_comm = "", prev_ent = ""}
    ...
    ^bb5:
      qoalahost.blk_meta  {block_id = "block_5", predecessors = ["block_2"], deadlines = {}, dependencies = ["block_2"], prev_comm = "", prev_ent = ""}
      %m2 = qoalahost.call @subrt2(%vqubit2) : (i32) -> i1
    
    ^bb6:
      qoalahost.blk_meta  {block_id = "block_6", predecessors = ["block_4"], deadlines = {}, dependencies = ["block_4"], prev_comm = "", prev_ent = ""}
      %m3 = qoalahost.call @subrt3(%vqubit3) : (i32) -> i1
    
    ^bb7:
      qoalahost.blk_meta  {block_id = "block_7", predecessors = [], deadlines = {}, dependencies = [], prev_comm = "", prev_ent = "block_4"}
