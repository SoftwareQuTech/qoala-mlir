...
module {
    ...
    ^bb3:
      qoalahost.blk_meta  {block_id = "block_3", predecessors = [], deadlines = {}, dependencies = [], prev_comm = "", prev_ent = "block_2"}
      %vqubit2 = qoalahost.call @req2() : () -> i32
    
    ^bb4:
      qoalahost.blk_meta  {block_id = "block_4", predecessors = ["block_2"], deadlines = {}, dependencies = ["block_2"], prev_comm = "", prev_ent = ""}
    ...
    ^bb6:
      qoalahost.blk_meta  {block_id = "block_6", predecessors = ["block_3"], deadlines = {}, dependencies = ["block_3"], prev_comm = "", prev_ent = ""}
      %m2 = qoalahost.call @subrt2(%vqubit2) : (i32) -> i1
    
    ^bb7:
      qoalahost.blk_meta  {block_id = "block_7", predecessors = ["block_5"], deadlines = {}, dependencies = ["block_5"], prev_comm = "", prev_ent = ""}
      %m3 = qoalahost.call @subrt3(%vqubit3) : (i32) -> i1
    
    ^bb8:
      qoalahost.blk_meta  {block_id = "block_8", predecessors = [], deadlines = {}, dependencies = [], prev_comm = "", prev_ent = "block_5"}
