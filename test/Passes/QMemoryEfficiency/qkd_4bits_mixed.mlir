...
module {
    ...
    ^bb3:
      qoalahost.blk_meta  {block_id = "block_3", predecessors = ["block_1"]}
      %m1 = qoalahost.call @subrt1(%vqubit1) : (i32) -> i1
    
    ^bb4:
      qoalahost.blk_meta  {block_id = "block_4", predecessors = []}
      %vqubit3 = qoalahost.call @req3() : () -> i32
    
    ^bb5:
      qoalahost.blk_meta  {block_id = "block_5", predecessors = ["block_2"]}
      %m2 = qoalahost.call @subrt2(%vqubit2) : (i32) -> i1
    
    ^bb6:
      qoalahost.blk_meta  {block_id = "block_6", predecessors = ["block_4"]}
