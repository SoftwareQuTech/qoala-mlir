...
// CHECK: - block_1::2: 1262
// CHECK: - block_2::2: 1251
// CHECK: - block_4::2: 157
...
module {
  ...
  qoalahost.main_func @test_measured_late() {
    ...
    ^bb9:
        qoalahost.blk_meta  {block_id = "block_9", deadlines = {}, dependencies = ["block_6"], predecessors = [], prev_comm = "", prev_ent = ""}
