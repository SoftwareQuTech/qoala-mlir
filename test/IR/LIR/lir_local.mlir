...
module {
  ...
  func.func @subrt1(%vqubit: i32) attributes {"qoala_func" = "local_routine"} {
    "netqasm.init"(%vqubit) : (i32) -> ()
    return
  }

  func.func @subrt2(%vqubit: i32, %angle_num: i32, %angle_denom: i32) attributes {"qoala_func" = "local_routine"} {
    "netqasm.rot_x"(%vqubit, %angle_num, %angle_denom) : (i32, i32, i32) -> ()
    return
  }

  func.func @subrt3(%vqubit: i32, %angle_num: i32, %angle_denom: i32) -> i1 
    attributes {"qoala_func" = "local_routine"} {
    "netqasm.rot_y"(%vqubit, %angle_num, %angle_denom) : (i32, i32, i32) -> ()
