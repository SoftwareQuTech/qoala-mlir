...
using MeasureQubitOpLowering = OpLoweringTemplate<qnet::MeasureOp, mlir::lir::MeasureOp>;

using NewQubitOpLowering = OpLoweringTemplate<qnet::NewQubitOp, mlir::lir::NewQubitOp>;
