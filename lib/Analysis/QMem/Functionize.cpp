...
ArgTypesAndReturns qoala::analysis::computeArgTypesAndReturns(SetVector<Operation *> &quantumOps) {
    ...
    return ArgTypesAndReturns{argTypes, resultTypes, opResultsIndexes};
}

func::FuncOp qoala::analysis::createNewFunctionWithOperations(
        OpBuilder *opBuilder, StringRef funcName,
        Location loc, SetVector<Operation *> &quantumOps) {
    ArgTypesAndReturns typesAndValues = computeArgTypesAndReturns(quantumOps);
...
void qoala::analysis::functionizeModule(ModuleOp &module, bool (*opCanBeFunctionized) (Operation *)) {
    ...
    module.walk([&](Operation *operation) {
        if (opCanBeFunctionized(operation)) {
