...
namespace
{
  ...
  struct RotXOpConversion : LirToSplitLirOpConversion<hir::RotXOp>
  {
    using LirToSplitLirOpConversion::LirToSplitLirOpConversion;
    LogicalResult
  ...
  struct RotYOpConversion : LirToSplitLirOpConversion<hir::RotYOp>
  {
    using LirToSplitLirOpConversion::LirToSplitLirOpConversion;
    LogicalResult
  ...
  patterns.insert<
      RotXOpConversion, RotYOpConversion
  >(patterns.getContext(), &valueMap);
