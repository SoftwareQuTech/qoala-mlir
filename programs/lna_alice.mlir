func @f() -> () {
    ...
    %a0b = "hir.gate_h"(%a0a) : (!hir.qubit) -> !hir.qubit
    %a0c = "hir.gate_h"(%a0b) : (!hir.qubit) -> !hir.qubit
    %a0d = "hir.gate_h"(%a0c) : (!hir.qubit) -> !hir.qubit
    %a0e = "hir.gate_h"(%a0d) : (!hir.qubit) -> !hir.qubit
    ...
    %f = "hir.recv_cmsg"() : () -> (!hir.cvalue)

    %zero = "hir.new_cval"() : () -> !hir.cvalue
    %a0f = "hir.rot_z"(%a0e, %zero) : (!hir.qubit, !hir.cvalue) -> !hir.qubit
    %a0g = "hir.gate_h"(%a0f) : (!hir.qubit) -> !hir.qubit
    %result = "hir.meas"(%a0g) : (!hir.qubit) -> !hir.cvalue
